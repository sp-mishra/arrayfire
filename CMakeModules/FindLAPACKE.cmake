...
message("LAPACKE_ROOT_DIR=${LAPACKE_ROOT_DIR}")
...
ENDIF()
message("PC_LAPACKE_FOUND=${PC_LAPACKE_FOUND}")
IF(PC_LAPACKE_FOUND)
...
MARK_AS_ADVANCED(
  ...
  LAPACKE_LIB
  lapacke_LIBRARY)
message("PC_LAPACKE_FOUND=${PC_LAPACKE_FOUND} LAPACKE_LIB=${LAPACKE_LIB} LAPACKE_INCLUDES=${LAPACKE_INCLUDES}")
