...
####### The input file was ArrayFireConfig.cmake.in                            ########
...
set_and_check(ArrayFire_INCLUDE_DIRS /Users/I501980/Documents/Code/Personal/arrayfire/include;${PACKAGE_PREFIX_DIR}/include)
...
foreach(backend Unified CPU OpenCL CUDA)
  ...
  if(NOT TARGET ArrayFire::af${lowerbackend} AND NOT TARGET af${lowerbackend})
    ...
    if(EXISTS ${PACKAGE_PREFIX_DIR}/cmake/ArrayFire${backend}Targets.cmake)
      include(${PACKAGE_PREFIX_DIR}/cmake/ArrayFire${backend}Targets.cmake)
    endif()
  endif()
